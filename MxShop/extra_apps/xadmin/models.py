...
class Bookmark(models.Model):
    ...
    user = models.ForeignKey(AUTH_USER_MODEL, verbose_name=_(u"user"), blank=True, null=True,default="",on_delete=models.CASCADE)
...
class UserSettings(models.Model):
    user = models.ForeignKey(AUTH_USER_MODEL, verbose_name=_(u"user"),default="",on_delete=models.CASCADE)
