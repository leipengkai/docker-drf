...
INSERT INTO `django_content_type` VALUES (34,'admin','logentry'),(2,'auth','group'),(1,'auth','permission'),(25,'authtoken','token'),(3,'contenttypes','contenttype'),(31,'dashboard','userdashboardmodule'),(8,'goods','banner'),(9,'goods','goods'),(10,'goods','goodscategory'),(11,'goods','goodscategorybrand'),(12,'goods','goodsimage'),(13,'goods','hotsearchwords'),(14,'goods','indexad'),(32,'jet','bookmark'),(33,'jet','pinnedapplication'),(4,'sessions','session'),(26,'social_django','association'),(27,'social_django','code'),(28,'social_django','nonce'),(30,'social_django','partial'),(29,'social_django','usersocialauth'),(15,'trade','ordergoods'),(16,'trade','orderinfo'),(17,'trade','shoppingcart'),(6,'users','member'),(5,'users','userprofile'),(7,'users','verifycode'),(18,'user_operation','useraddress'),(19,'user_operation','userfav'),(20,'user_operation','userleavingmessage'),(21,'xadmin','bookmark'),(24,'xadmin','log'),(22,'xadmin','usersettings'),(23,'xadmin','userwidget');
...
INSERT INTO `django_session` VALUES ('yysix8fv60qaj02o2c2t4x1hv9t5k2s2','NzE0NDE1ODg5MDczODg5MzA4NWU2ZDc5OGVmZDFmMTdjYjQzZjQ1Njp7Il9hdXRoX3VzZXJfaWQiOiIxIiwiX2F1dGhfdXNlcl9iYWNrZW5kIjoidXNlcnMudmlld3MuQ3VzdG9tQmFja2VuZCIsIl9hdXRoX3VzZXJfaGFzaCI6IjYwYWMxNzNkODc0MWRmMmYwNmRlMzYzYjE1ZWNiZmY1OTA1MmM0ZmYifQ==','2018-04-23 20:13:16.319512');
...
CREATE TABLE `users_member` (
  ...
  `sign_sum` int(11) NOT NULL,
  `share_sum` int(11) NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `users_userprofile` VALUES (1,'pbkdf2_sha256$100000$as15N3Fv793u$vl9hVZgZFPYHk3uwVwKvKtCMrhFuOQXYpfbHjqOLXDU=','2018-04-09 20:13:16.221418',1,'admin','','',1,1,'2018-04-09 20:12:48.423408',NULL,NULL,'female',NULL,'admin@qq.com',0,0,0,0,0);
...
-- Dump completed on 2018-04-09 20:15:48
